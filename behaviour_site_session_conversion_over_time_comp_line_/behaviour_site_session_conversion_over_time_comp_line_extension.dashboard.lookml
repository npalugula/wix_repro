- dashboard: behaviour_site_session_conversion_over_time_comp_line_extension
  extension : required
  ...
  - title: "dashboard_title"
    ...
    explore: conversion
    type: looker_line
    fields: [traffic.comparison_timeframe, traffic.sessions_count, transactions_sales.orders]
    filters: {}
    ...
    color_application:
      ...
      options:
        steps: 5
    y_axes: [{label: '', orientation: left, series: [{axisId: traffic.sessions_count,
            id: Current period - traffic.sessions_count, name: "current_period"}],
