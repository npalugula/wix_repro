- dashboard: behaviour_site_session_conversion_over_time_split_line_advanced
  extends:  [behaviour_site_session_conversion_over_time_split_line_extension, conversion_filters_more]
  elements:
