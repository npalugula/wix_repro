- dashboard: behaviour_site_session_conversion_over_time_table_extension
  extension : required
  ...
  - title: "dashboard_title"
    ...
    listen:
      ...
      session_user_aquisition: traffic.session_user_aquisition
    row: 0
    col: 0
    width: 24
    height: 12
  ...
  - name: columns_to_show
    default_value: 01.{{_localization['conversion_timeframe']}},25.{{_localization['sessions_count']}},29.{{_localization['orders']}},31.{{_localization['conversion_sales_rate']}}
