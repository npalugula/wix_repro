- dashboard: blog_posts_over_time_table_extension
  extension : required
  ...
  - title: "dashboard_title"
    ...
    sorts: [blog_main.action_date_tab desc]
    limit: 1500
    ...
    series_text_format:
      ...
      blog_main.post_scroll_rate_tab:
        fg_color: "#162D3D"
      blog_main.bounce_rate_tab:
        fg_color: "#162D3D"
      blog_main.avg_reading_time_tab:
        fg_color: "#162D3D"
      blog_main.post_comments_count_tab:
        fg_color: "#162D3D"
      blog_main.post_likes_count_tab:
    ...
    defaults_version: 1
    series_types: {}
    hidden_fields: [blog_main.cover_image_url_tab,
             blog_main.post_title_tab,
             blog_main.last_published_date_tab,
             blog_main.first_published_date_tab,
             blog_main.is_featured_tab,
  ...
  - name: columns_to_show
    default_value: 07.{{_localization['post_action_date']}},08.{{_localization['post_view_count']}},10.{{_localization['post_visitors_count']}},13.{{_localization['comments_count']}},14.{{_localization['likes_count']}},15.{{_localization['share_count']}}
