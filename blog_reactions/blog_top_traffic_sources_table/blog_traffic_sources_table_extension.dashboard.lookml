- dashboard: blog_traffic_sources_table_extension
  extension : required
  extends : [filter_date, filter_select_columns]
  title: "blog_top_traffic_sources"
  layout: newspaper
  ...
  - title: "dashboard_title"
    ...
    fields: [blog_main.cover_image_url_tab,
             ...
             blog_main.referrer_source_tab,
             blog_main.ref_domain_tab,
  ...
  - name: columns_to_show
    default_value: 08.{{_localization['referrer_source']}},09.{{_localization['ref_domain']}},10.{{_localization['post_view_count']}},12.{{_localization['post_visitors_count']}}
    explore: blog_traffic_columns
    field: blog_traffic_columns.translation
