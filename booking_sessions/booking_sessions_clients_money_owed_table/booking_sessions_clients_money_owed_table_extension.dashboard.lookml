- dashboard: booking_sessions_clients_money_owed_table_extension
  extension : required
  extends : [filter_select_columns, bookings_client_name_filter, bookings_staff_name_filter]
  preferred_viewer: dashboards-next
  title: "clients_who_owed_me_money"
  layout: newspaper
  elements:
  - title: "dashboard_title"
    ...
    filters:
      ...
      bookings.amount_owed: ">0"
      bookings_sessions.custom_period: 365 days
    sorts: [bookings_sessions.amount_owed_tab desc]
    limit: 1500
  ...
  - name: columns_to_show
    default_value: 02.{{_localization['client_name']}},03.{{_localization['client_email']}},06.{{_localization['service_title']}},01.{{_localization['booking_sessions_comparison_timeframe_day']}},28.{{_localization['amount_local_currency']}},25.{{_localization['amount_paid']}},27.{{_localization['booking_amount_owed']}}
