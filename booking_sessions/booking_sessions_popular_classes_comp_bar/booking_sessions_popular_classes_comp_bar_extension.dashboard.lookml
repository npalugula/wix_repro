- dashboard: booking_sessions_popular_classes_comp_bar_extension
  extension: required
  extends: [filter_date, filter_compare_to, filter_top_n_items, filter_choose_measure]
  preferred_viewer: dashboards-next
  title: "booking_sessions_popular_classes"
  layout: newspaper
  elements:
  - title: "dashboard_title"
    ...
    type: looker_bar
    fields: [bookings_sessions.service_details, bookings_sessions.rank_limit, bookings_sessions.choosable_measure, bookings_sessions.is_current_period_name]
    ...
    filters:
      ...
      bookings_sessions.service_type_val: service_type_group
    limit: 5000
    column_limit: 50
  ...
  - name: choose_measure
    default_value: totalParticipants
    ui_config:
      options:
      - totalParticipants
      - occupancyRate
      - avgParticipantsInClass
      - checkedIn
      - checkedInRate
    explore: bookings_sessions
