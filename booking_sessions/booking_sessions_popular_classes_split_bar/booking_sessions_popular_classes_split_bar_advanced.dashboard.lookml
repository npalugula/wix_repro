- dashboard: booking_sessions_popular_classes_split_bar_advanced
  extends: [booking_sessions_popular_classes_split_bar_extension, booking_sessions_filters_more]
  elements:
