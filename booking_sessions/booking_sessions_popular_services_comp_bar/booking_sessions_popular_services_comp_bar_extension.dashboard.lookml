- dashboard: booking_sessions_popular_services_comp_bar_extension
  extension: required
  extends: [filter_date, filter_compare_to, filter_top_n_items, filter_choose_measure]
  preferred_viewer: dashboards-next
  title: "booking_sessions_popular_services"
  layout: newspaper
  elements:
  - title: "dashboard_title"
    name: "booking_sessions_popular_services_comp_bar"
    title_hidden: true
    model: analytics
    explore: bookings_sessions
    type: looker_bar
    fields: [bookings_sessions.service_name_with_the_session_type, bookings_sessions.rank_limit, bookings_sessions.choosable_measure, bookings_sessions.is_current_period_name]
