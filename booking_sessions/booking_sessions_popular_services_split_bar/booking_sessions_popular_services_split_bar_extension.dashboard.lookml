- dashboard: booking_sessions_popular_services_split_bar_extension
  extension: required
  ...
  - title: "dashboard_title"
    name: "booking_sessions_popular_services_split_bar"
    title_hidden: true
    model: analytics
    explore: bookings_sessions
    type: looker_bar
    fields: [bookings_sessions.service_name_with_the_session_type, bookings_sessions.rank_limit, bookings_sessions.choosable_split_by,
