- dashboard: booking_sessions_staff_activity_comp_bar_extension
  extension: required
  ...
  - title: "dashboard_title"
    name: "booking_sessions_staff_activity_comp_bar"
    title_hidden: true
    model: analytics
    explore: bookings_sessions
    type: looker_bar
    fields: [bookings_resource.staff_name, bookings_sessions.rank_limit, bookings_sessions.choosable_measure, bookings_sessions.is_current_period_name]
