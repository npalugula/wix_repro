- dashboard: booking_sessions_staff_activity_table_extension
  extension : required
  extends : [filter_date, filter_select_columns]
  title: "booking_sessions_staff_activity"
  layout: newspaper
  elements:
  ...
  - name: columns_to_show
    default_value: 07.{{_localization['booking_session_staff_name']}},30.{{_localization['booking_sessions_count']}},23.{{_localization['booking_number_of_participants']}},34.{{_localization['booking_attendees']}},31.{{_localization['booking_sessions_duration']}},25.{{_localization['amount_paid']}},26.{{_localization['booking_amount_pending']}}
