- dashboard: button_clicks_over_time_table_advanced
  extends: [button_clicks_over_time_table_extension, button_clicks_filters_more, button_clicks_filters_page_url
