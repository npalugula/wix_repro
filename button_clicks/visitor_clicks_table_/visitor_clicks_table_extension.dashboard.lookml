- dashboard: visitor_clicks_table_extension
  extension : required
  extends : [filter_date, button_clicks_filters_element_type, button_clicks_filters_page_url_from, filter_select_columns]
  preferred_viewer: dashboards-next
  title: "visitor_clicks"
  layout: newspaper
  elements:
  - title: "dashboard_title"
    name: "visitor_clicks_table"
    title_hidden: true
    model: analytics
    ...
    sorts: [traffic_main.unique_clicks_count_tab desc]
    limit: 1500
    column_limit: 50
    ...
    series_column_widths:
      traffic_main.comparison_timeframe: 92
      traffic_main.element_details_tab: 300
      traffic_main.link_to_and_details_tab: 300
    ...
    totals_color: "#808080"
    hidden_fields: [traffic_main.comparison_timeframe_tab, traffic_main.visitor_type_tab,
      traffic_main.referrer_source_tab, traffic_main.referrer_domain_tab,
      traffic_main.ref_url_tab, traffic_main.country_name_tab,
      traffic_main.region_tab, traffic_main.city_tab, traffic_main.postal_code_tab, traffic_main.device_type_tab,
      traffic_main.browser_family_tab, traffic_main.browser_version_tab, traffic_main.os_name_tab,
  ...
  - name: columns_to_show
    default_value: 14.{{ _localization['element_details'] }},17.{{ _localization['link_to_and_details'] }},20.{{ _localization['button_clicks_page_url_from'] }},24.{{ _localization['button_clicks_visitors_count'] }},26.{{ _localization['unique_clicks_count'] }},27.{{ _localization['clicks_ctr'] }}
