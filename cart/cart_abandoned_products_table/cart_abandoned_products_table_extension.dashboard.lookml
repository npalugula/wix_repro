- dashboard: cart_abandoned_products_table_extension
  extension: required
  ...
  - title: "dashboard_title"
    ...
    filters:
      ...
      cart_main.cart_id: '-NULL'
    sorts: [cart_main.abandoned_count_table desc]
    limit: 1500
    column_limit: 50
    ...
    totals_color: "#808080"
    hidden_fields: [cart_main.comparison_timeframe_table
                   ,cart_main.recovered_date_table
                   ,cart_main.completed_date_table
                   ,cart_main.cart_status_table
                   ,cart_main.cart_currency_table
  ...
  - name: columns_to_show
    default_value: 14.{{ _localization['line_item_picture'] }},15.{{ _localization['line_item_name'] }},35.{{ _localization['abandoned_count'] }},42.{{ _localization['completed_count'] }},43.{{ _localization['abandoned_rate'] }},47.{{ _localization['completion_rate'] }}
