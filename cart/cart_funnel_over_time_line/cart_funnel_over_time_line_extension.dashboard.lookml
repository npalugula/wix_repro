- dashboard: cart_funnel_over_time_line_extension
  extension : required
  extends : [filter_date, filter_group_by_date, filter_choose_measure_type]
  ...
  - title: "dashboard_title"
    ...
    explore: cart_main
    type: looker_line
    fields: [cart_main.choosable_measure_cart, cart_main.choosable_measure_abandoned, cart_main.choosable_measure_recoverable, cart_main.choosable_measure_recovered, cart_main.comparison_timeframe]
    filters:
