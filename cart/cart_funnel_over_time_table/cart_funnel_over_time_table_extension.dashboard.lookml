- dashboard: cart_funnel_over_time_table_extension
  extension: required
  extends: [filter_date, filter_group_by_date, filter_select_columns]
  preferred_viewer: dashboards-next
  title: "cart_funnel_over_time"
  layout: newspaper
  elements:
  ...
  - name: columns_to_show
    default_value: 01.{{ _localization['date'] }},29.{{ _localization['cart_count'] }},35.{{ _localization['abandoned_count'] }},37.{{ _localization['recoverable_count'] }},39.{{ _localization['recovered_count'] }}
