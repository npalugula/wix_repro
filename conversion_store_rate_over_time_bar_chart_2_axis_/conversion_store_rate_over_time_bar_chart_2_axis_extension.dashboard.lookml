- dashboard: conversion_store_rate_over_time_bar_chart_2_axis_extension
  extension : required
  extends : [filter_date, filter_group_by_date, filter_choose_measure, filter_choose_measure_2]
  preferred_viewer: dashboards-next
  title: "conversion_store_rate_over_time"
  layout: newspaper
  elements:
  - title: "dashboard_title"
    name: "conversion_store_rate_over_time_bar_chart_2_axis"
    title_hidden: true
    model: analytics
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: traffic.choosable_measure,
          id: traffic.choosable_measure, name: Converted sessions}], showLabels: false,
      ...
      label: '', orientation: right, series: [{axisId: traffic.choosable_measure_rate,
          id: traffic.choosable_measure_rate, name: Converted Sessions Rate}], showLabels: false,
      showValues: false, unpinAxis: false, tickDensity: default, type: linear}]
    hide_legend: false
    font_size: 12px
    series_types:
    ...
    series_colors:
      traffic.choosable_measure_rate: "#101F69"
    series_labels: {}
