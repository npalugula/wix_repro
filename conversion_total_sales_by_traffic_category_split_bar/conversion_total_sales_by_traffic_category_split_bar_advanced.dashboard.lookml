- dashboard: conversion_total_sales_by_traffic_category_split_bar_advanced
  extends:  [conversion_total_sales_by_traffic_category_split_bar_extension, conversion_filters_more]
  elements:
