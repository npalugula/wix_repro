- dashboard: conversion_total_sales_by_traffic_category_split_line_advanced
  extends:  [conversion_total_sales_by_traffic_category_split_line_extension, conversion_filters_more]
  elements:
